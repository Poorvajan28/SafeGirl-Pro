...
ThemeData get lightTheme => ThemeData(
  ...
  textTheme: TextTheme(
    displayLarge: GoogleFonts.spaceGrotesk(fontSize: FontSizes.displayLarge, fontWeight: FontWeight.bold),
    displayMedium: GoogleFonts.spaceGrotesk(fontSize: FontSizes.displayMedium, fontWeight: FontWeight.bold),
    displaySmall: GoogleFonts.spaceGrotesk(fontSize: FontSizes.displaySmall, fontWeight: FontWeight.w600),
    headlineLarge: GoogleFonts.spaceGrotesk(fontSize: FontSizes.headlineLarge, fontWeight: FontWeight.w600),
    headlineMedium: GoogleFonts.spaceGrotesk(fontSize: FontSizes.headlineMedium, fontWeight: FontWeight.w600),
    headlineSmall: GoogleFonts.spaceGrotesk(fontSize: FontSizes.headlineSmall, fontWeight: FontWeight.bold),
    ...
    bodyLarge: GoogleFonts.inter(fontSize: FontSizes.bodyLarge, fontWeight: FontWeight.normal, height: 1.5),
    bodyMedium: GoogleFonts.inter(fontSize: FontSizes.bodyMedium, fontWeight: FontWeight.normal, height: 1.5),
    bodySmall: GoogleFonts.inter(fontSize: FontSizes.bodySmall, fontWeight: FontWeight.normal, height: 1.5),
  ),
